...
The project SHALL have a `pyproject.toml` at the repository root defining the package `bookkeeping` with Python ≥3.10 requirement, setuptools build backend, and all runtime dependencies (piecash ≥1.2.0, weasyprint ≥60.0, Jinja2 ≥3.1) and test dependencies (pytest ≥7.0).
