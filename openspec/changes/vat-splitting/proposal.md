...
- Implement `bookkeeping/vat.py` with `apply_vat_split(amount: Decimal, vat_rate: Decimal) -> VATSplit`
...
- **Code**: New module `bookkeeping/vat.py` and test file `tests/test_vat.py`
